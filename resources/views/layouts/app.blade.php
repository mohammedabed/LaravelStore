            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        ...
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">{{ config('app.name') }}</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>Palestine <br> Gaza <br> +972569933916 <br> aabedmuhamad@gmail.com</p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Follow Us On</h3>
                        <ul>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>developed by Mohammed Abed</p>
                        <p>LaravelStore &copy; 2021. All Rights Reserved</p>
                    </div>
